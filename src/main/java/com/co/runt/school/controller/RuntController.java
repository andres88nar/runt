...
public class RuntController {
    ...
    private void init(){        
     ...
     nemesis.setLisSubjects(new ArrayList <Subjects> (Arrays.asList(matematicas, preIcfes)));
     priapo.setLisSubjects(new ArrayList <Subjects> (Arrays.asList(español)));
     nemesis.setLisSubjects(new ArrayList <Subjects> (Arrays.asList(inglesBasico, inglesAvanzado)));
     ...
     servicRunt.searchTeacher(nemesis);
     
     filterTeacher(nemesis);
     
   //  filterTeacher(priapo);
   ...
   //  filterTeacher(iris);
    ...
    private void saveSchool(School Olimpo) {
    ...
    public void filterTeacher(Teacher teacherfilter){
